 ...
 */
public class TestAnParser_CSD07 extends TestCase {
    ...
    public TestAnParser_CSD07(String testName) throws IOException {
        super(testName);
    }
    ...
    public void testParse() throws Exception {
        ...
        assertEquals(resultDoc.objClass, 
                "org.akomantoso.schema.v3.csd07.OpenStructure");
