 ...
 */
public class TestAnValidatorTest_CSD13 extends TestCase {
    
    AnVersion _version = new AnVersion(3, "CSD13");
    // test file 1 - this should validte
    File _validate1  = new File("./src/test/java/testdocs/akomantoso_doc_csd13.xml");
    // test file 2 - this should fail 
    File _validate2  = new File("./src/test/java/testdocs/akomantoso_act_csd13.xml");
    
    AnValidator _validator = new AnValidator();
    
    public TestAnValidatorTest_CSD13(String testName) throws IOException {
        super(testName);
    }
    ...
    public void testValidate() throws Exception {
        ...
        assertEquals("line number should be 209 !", result.getLineNumber(), (Integer)40);
        assertEquals("col number should be 131 !", result.getColumnNumber(), (Integer)100);
    }
}
