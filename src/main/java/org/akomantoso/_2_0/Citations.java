 ...
 *         &lt;element ref="{http://www.akomantoso.org/2.0}citation" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
public class Citations {
    ...
    protected List<ItemType> citation;
     ...
     * 
     */
    public List<ItemType> getCitation() {
        if (citation == null) {
            citation = new ArrayList<ItemType>();
        }
