 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;name xmlns="http://www.akomantoso.org/2.0" xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;parliamentaryAnalysis&lt;/name&gt;
 * </pre>
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;comment xmlns="http://www.akomantoso.org/2.0" xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;The complex type parliamentaryAnalysis is a list of all the parliamentary analysis elements that can be used on the analysis of a debate&lt;/comment&gt;
 * </pre>
 * 
 * 
 ...
 *         &lt;element ref="{http://www.akomantoso.org/2.0}quorumVerification"/>
 *         &lt;element ref="{http://www.akomantoso.org/2.0}voting"/>
 *         &lt;element ref="{http://www.akomantoso.org/2.0}recount"/>
 *       &lt;/choice>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ParliamentaryAnalysis {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "recount", namespace = "http://www.akomantoso.org/2.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "voting", namespace = "http://www.akomantoso.org/2.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "quorumVerification", namespace = "http://www.akomantoso.org/2.0", type = JAXBElement.class, required = false)
    })
