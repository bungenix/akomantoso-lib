 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.akomantoso.org/2.0}componentRef" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
public class Attachments {
    ...
    protected List<SrcType> componentRef;
     ...
     * 
     */
    public List<SrcType> getComponentRef() {
        if (componentRef == null) {
            componentRef = new ArrayList<SrcType>();
        }
