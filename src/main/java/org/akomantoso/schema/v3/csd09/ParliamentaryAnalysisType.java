 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;name xmlns="http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09" xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;parliamentaryAnalysisType&lt;/name&gt;
 * </pre>
 * 
 * <pre>
 ...
 *         &lt;element ref="{http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09}quorum"/>
 *         &lt;element ref="{http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09}count"/>
 *       &lt;/choice>
 *       &lt;attGroup ref="{http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09}idreq"/>
 *       &lt;attGroup ref="{http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09}linkopt"/>
 ...
 *       &lt;attGroup ref="{http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09}outcome"/>
...
public class ParliamentaryAnalysisType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "count", namespace = "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "quorum", namespace = "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09", type = JAXBElement.class, required = false)
    })
