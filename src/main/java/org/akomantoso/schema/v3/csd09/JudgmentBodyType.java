 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;name xmlns="http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09" xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;judgmentBodyType&lt;/name&gt;
 * </pre>
 * 
 * <pre>
 ...
 *         &lt;group ref="{http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09}judgmentBlock"/>
 *       &lt;/sequence>
...
public class JudgmentBodyType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "motivation", namespace = "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "introduction", namespace = "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "decision", namespace = "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "remedies", namespace = "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "arguments", namespace = "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "background", namespace = "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD09", type = JAXBElement.class, required = false)
    })
