 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;name xmlns="http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD10" xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;parliamentaryAnalysis&lt;/name&gt;
 * </pre>
 * 
 * <pre>
 ...
 *         &lt;element ref="{http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD10}quorumVerification"/>
 *         &lt;element ref="{http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD10}voting"/>
 *         &lt;element ref="{http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD10}recount"/>
 *       &lt;/choice>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ParliamentaryAnalysis {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "recount", namespace = "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "quorumVerification", namespace = "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD10", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "voting", namespace = "http://docs.oasis-open.org/legaldocml/ns/akn/3.0/CSD10", type = JAXBElement.class, required = false)
    })
